...
#define SPBLASI_has_repeated_indices(p)    ((p).repeated_indices == blasi_repeated_indices)


#define SPBLASI_is_double_precision(p)     ((p).scalar_type == blasi_double_precision)
...
#define SPBLASI_is_symmetric(p)            (SPBLASI_is_upper_symmetric(p) || SPBLASI_is_lower_symmetric(p))
...
#define SPBLASI_is_triangular(p)           (SPBLASI_is_upper_triangular(p) || SPBLASI_is_lower_triangular(p))
...
#define SPBLASI_is_hermitian(p)            (SPBLASI_is_upper_hermitian(p) || SPBLASI_is_lower_hermitian(p))
...
#define SPBLASI_set_double_precision(p)    ((p)->precision_type = blasi_double_precision)
#define SPBLASI_set_single_precision(p)    ((p)->precision_type = blasi_single_precision)
