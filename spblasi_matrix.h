...
#define SPBLASI_Matrix_is_zero_base(A)     SPBLASI_is_zero_base(SPBLASI_Matrix_prop(A))
#define SPBLASI_Matrix_is_one_base(A)      SPBLASI_is_one_base(SPBLASI_Matrix_prop(A))

#define SPBLASI_Matrix_set_general(A)      SPBLASI_set_general(&SPBLASI_Matrix_prop(A))
#define SPBLASI_Matrix_set_complex(A)      SPBLASI_set_complex(&SPBLASI_Matrix_prop(A))
#define SPBLASI_Matrix_set_lower_symmetric(A)    SPBLASI_set_lower_symmetric(&SPBLASI_Matrix_prop(A))
...
void SPBLASI_Matrix_set_state(SPBLASI_Matrix *A, enum SPBLASI_Matrix_state_type s);

SPBLASI_Matrix_prop_type SPBLASI_Matrix_get_property_tag(const SPBLASI_Matrix *A);

void SPBLASI_Matrix_set_property_tag(SPBLASI_Matrix *A, SPBLASI_Matrix_prop_type prop);

SPBLASI_Matrix *SPBLASI_Matrix_new(int M, int N, SPBLASI_Matrix_prop_type prop);
SPBLASI_Matrix *SPBLASI_Matrix_new_block(int Mb, int Nb, int k, int l, SPBLASI_Matrix_prop_type prop);
SPBLASI_Matrix *SPBLASI_Matrix_new_variable_block(int Mb, int Nb, const int *K, const int *L,
